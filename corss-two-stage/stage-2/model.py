...
from models.SCAN import ContrastiveLoss1,feature_ContrastiveLoss1
...
class DIME(object):
    def __init__(self, opt):
        ...
        self.scan_criterion = feature_ContrastiveLoss1(opt, margin=opt.margin,
                                            max_violation=opt.max_violation)
    ...
    def forward_emb(self, batch_data, volatile=False):
        ...
        img_emb, rgn_emb = self.img_enc(images, boxes, imgs_wh)
        return img_emb, rgn_emb, stc_emb, wrd_emb

    def train_emb(self, epoch, batch_data, writer, *args):
        ...
        #加入SCAN模块
        #用到self_att_emb,word_emb,lengths
        scan_loss = self.scan_criterion(self_att_emb, word_emb, lengths)
        #self_att_emb: num*region*dim , word_emb: num*lenth*dim

        #
        #writer.add_graph(self.itr_module, (self_att_emb, img_emb, word_emb, stc_emb, lengths))
        #
