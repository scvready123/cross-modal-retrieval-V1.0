...
class InteractionModule(nn.Module):
    def __init__(self, opt, num_layer_routing=3, num_cells=4, path_hid=128):
        ...
        self.dynamic_itr_l0 = DynamicInteraction_Layer0(opt, 2, 2)
        self.dynamic_itr_l1 = DynamicInteraction_Layer(opt, 2, 2)
        self.dynamic_itr_l2 = DynamicInteraction_Layer(opt, 2, 2)
        self.dynamic_itr_l3 = DynamicInteraction_Layer(opt, 2, 2)
        self.dynamic_itr_l4 = DynamicInteraction_Layer(opt, 2, 1)
    ...
    def forward(self, rgn, img, wrd, stc, stc_lens):
        pairs_emb_lst = self.dynamic_itr_l0(rgn, img, wrd, stc, stc_lens)
        pairs_emb_lst = self.dynamic_itr_l1(pairs_emb_lst, rgn, img, wrd, stc, stc_lens)
        pairs_emb_lst = self.dynamic_itr_l2(pairs_emb_lst, rgn, img, wrd, stc, stc_lens)
        pairs_emb_lst = self.dynamic_itr_l3(pairs_emb_lst, rgn, img, wrd, stc, stc_lens)
        pairs_emb_lst = self.dynamic_itr_l4(pairs_emb_lst, rgn, img, wrd, stc, stc_lens)
