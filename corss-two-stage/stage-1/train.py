...
def main():
    ...
    parser.add_argument('--val_step', default=50000, type=int, help='Number of steps to run validation.')
    ...
    for epoch in range(opt.num_epochs):
        ...
        save_checkpoint({
            ...
            't_module': model.txt_enc.state_dict(),
            'i_module': model.img_enc.state_dict(),
            'best_rsum': best_rsum,
            'best_r1': best_r1, 
            'opt': opt,
            'Eiters': model.Eiters,
